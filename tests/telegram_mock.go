...
func (m *MockTelegramClient) ReplyMessage(update tgbotapi.Update, text string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReplyMessage", update, text)
}

// ReplyMessage indicates an expected call of ReplyMessage.
func (mr *MockTelegramClientMockRecorder) ReplyMessage(update, text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReplyMessage", reflect.TypeOf((*MockTelegramClient)(nil).ReplyMessage), update, text)
}
